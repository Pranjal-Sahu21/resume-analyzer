...
export default function ResumeReview({
  ...
  return (
    <div className="bg-white/5 border border-white/6 rounded-2xl p-6 w-full h-full max-w-xl">
      <div className="flex items-center justify-between">
        <div>
          <div className="text-white font-semibold">Resume Review</div>
      ...
      <div className="mt-4 text-right">
        <button className="px-4 py-2 rounded-md bg-gradient-to-r from-indigo-500 to-pink-500 text-white font-semibold">
